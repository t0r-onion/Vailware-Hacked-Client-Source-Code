...
import toniqx.vailware.modules.render.OldHitting;
import toniqx.vailware.modules.render.RotateItem;
...
public class ItemRenderer {
	...
	public void transformFirstPersonItem(float equipProgress, float swingProgress) {
		...
		GlStateManager.scale(OldHitting.itemSize.getValue(), OldHitting.itemSize.getValue(), OldHitting.itemSize.getValue());
	}
	...
	public void renderItemInFirstPerson(float partialTicks) {
		...
		float f = 1 - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * partialTicks);
	...
	public void updateEquippedItem() {
		...
		float f2 = 0.4F;
		if(OldHitting.armY.getValue() == 1) {
			handY = 1;
		}else {
			handY = (float) OldHitting.armY.getValue();
		}
		float f = flag ? 0.0F : handY;
