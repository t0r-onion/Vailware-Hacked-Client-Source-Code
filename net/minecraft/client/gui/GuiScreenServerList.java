...
public class GuiScreenServerList extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        mc.FontRendererNormal.drawCenteredString(I18n.format("selectServer.direct", new Object[0]), this.width / 2, 20, 16777215);
        mc.FontRendererNormal.drawString(I18n.format("addServer.enterIp", new Object[0]), this.width / 2 - 100, 100, 10526880);
