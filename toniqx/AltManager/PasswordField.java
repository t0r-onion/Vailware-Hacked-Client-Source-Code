    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                Gui.drawRect(this.xPos - 0.5f, this.yPos - 0.5f, this.xPos + this.width + 0.5f, this.yPos + this.height + 0.5f, -6250336);
            ...
            if (var4.length() > 0) {
                ...
                var9 = Minecraft.getMinecraft().FontRendererNormal.drawStringWithShadow(this.text.replaceAll("(?s).", "*"), var7, var8 - 1, var1);
            }
            ...
            if (var6) {
                if (var10) {
                	...
                	Minecraft.getMinecraft().FontRendererNormal.drawStringWithShadow("_", var4.length() > 0 ? var11 * 2 + 1: var11 - 2, var8 - 3, var1);
                }
            }
            if (var3 != var2) {
