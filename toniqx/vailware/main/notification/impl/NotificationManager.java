...
public class NotificationManager {
	...
	public Notification createNotification(String title, String text, boolean showTimer, long timeOnScreen, Type type, Color color) {
		...
		Notification n = new Notification(title, text, showTimer, timeOnScreen, type, color, defaultTargetX, defaultTargetY, GuiScreen.width, defaultStartingY, defaultSpeed);
	...
	public void onRender() {
		...
		defaultStartingX = GuiScreen.width;
		defaultStartingY = sr.getScaledHeight();
		defaultTargetX = sr.getScaledWidth() - 140;
		defaultTargetY = 0;
