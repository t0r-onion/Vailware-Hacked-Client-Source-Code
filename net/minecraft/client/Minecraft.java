...
import toniqx.vailware.main.authentication.GuiLogin;
...
{
	public static GlyphPageFontRenderer FontRendererMiniture;
	public static GlyphPageFontRenderer FontRendererArray;
	public static GlyphPageFontRenderer FontRendererClean;
	public static GlyphPageFontRenderer FontRendererTiny;
	public static GlyphPageFontRenderer FontRendererSmall;
	public static GlyphPageFontRenderer FontRendererNormal;
	public static GlyphPageFontRenderer FontRendererLarge;
	public static GlyphPageFontRenderer FontRendererHuge;
	public static GlyphPageFontRenderer FontRendererArrayBold;
	public static GlyphPageFontRenderer FontRendererTinyBold;
	public static GlyphPageFontRenderer FontRendererSmallBold;
	public static GlyphPageFontRenderer FontRendererNormalBold;
	public static GlyphPageFontRenderer FontRendererBig;
	public static GlyphPageFontRenderer FontRendererLargeBold;
	public static GlyphPageFontRenderer FontJello;
	
	public static ServerData clientLastServer;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.ingameGUI = new ModuleArrayList(this);
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
            	inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("vail/smallicon.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("vail/taskbaricon.png"));
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if(Keyboard.isKeyDown(Keyboard.KEY_LMENU)) {
                	if(!Client.getModule("FreeLook").isEnabled()) {
                		Client.getModule("FreeLook").toggle();
                	}
                }else {
                	if(Client.getModule("FreeLook").isEnabled()) {
                		Client.getModule("FreeLook").toggle();
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Client.getInstance().getVailRPC().update("", "Singleplayer");
    }
