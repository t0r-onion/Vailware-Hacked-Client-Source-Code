...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public static float rotationPitchHead = 0;
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            Client.onEvent(eventRenderEntity);
            ...
            try
            {
                ...
                if (ScaffoldRenderUtils.SetCustomYaw && entity == Minecraft.getMinecraft().thePlayer) {
                	f = ScaffoldRenderUtils.getCustomYaw();
                }else if(!ScaffoldRenderUtils.SetCustomYaw && entity == Minecraft.getMinecraft().thePlayer) {
                	f = Minecraft.getMinecraft().thePlayer.rotationYaw;
                }
                float f1 = (entity == Minecraft.getMinecraft().thePlayer) ? Minecraft.getMinecraft().thePlayer.rotationYaw : this.interpolateRotation(entity.prevRotationYawHead, entity.rotationYawHead, partialTicks);
                if (ScaffoldRenderUtils.SetCustomYaw && entity == Minecraft.getMinecraft().thePlayer) {
                	f1 = ScaffoldRenderUtils.getCustomYaw();
                }
                ...
                if (ScaffoldRenderUtils.SetCustomPitch && entity == Minecraft.getMinecraft().thePlayer) {
                	f8 = ScaffoldRenderUtils.getCustomPitch();
                }
