...
public class CircleManager {
	...
	public void drawCircle(Circle c){
    	...
    	if(!c.complete)
    		...
    		RenderUtils.drawBorderedCircle((int)c.x, (int)c.y, progress, new Color(1f, 1f, 1f, (1-Math.min(1f, Math.max(0f, (float)(progress/c.topRadius))))/2).getRGB(), new Color(1f, 1f, 1f, (1-Math.min(1f, Math.max(0f, (float)(progress/c.topRadius))))/2).getRGB());
