...
import toniqx.vailware.ui.clickui.ClickHUD.Handle;
...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
        ...
        else
        {
        	...
        	buttonList.add(new GuiButton(1, width/2 - 30, posY - 14, 58, 12, "Statistics"));
        }
    }
    
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        mc.FontRendererNormal.drawString(I18n.format("container.crafting", new Object[0]), 86, 8, 4210752);
    }
