...
public class GuiRenameWorld extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        mc.FontRendererLarge.drawCenteredString(I18n.format("selectWorld.renameTitle", new Object[0]), this.width / 2, 18, 16777215);
        mc.FontRendererNormal.drawString(I18n.format("selectWorld.enterName", new Object[0]), this.width / 2 - 100, 44, 10526880);
