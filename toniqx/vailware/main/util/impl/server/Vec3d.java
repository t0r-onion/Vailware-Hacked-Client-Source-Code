...
public class Vec3d
{
    ...
    public Vec3d scale(final double p_1866781) {
        return new Vec3d(this.xCoord * p_1866781, this.yCoord * p_1866781, this.zCoord * p_1866781);
    }

    @Override
    public boolean equals(final Object p_equals1) {
        if (this == p_equals1) {
            return true;
        }
        if (!(p_equals1 instanceof Vec3d)) {
            return false;
        }
        final Vec3d vec3d = (Vec3d)p_equals1;
