...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(9, this.width / 2 - 100, this.height / 4 + 96 + i, 98, 20, I18n.format("Radio", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 9:
                mc.displayGuiScreen(new RadioGUI(null));
                break;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (Category category : Category.values()) {
            ...
            Gui.drawRect(GuiScreen.width / 2 - 110, GuiScreen.height / 4 - 21, GuiScreen.width / 2 + 110, GuiScreen.height / 4 - 20, ColorUtil.getRainbow(9, 0.8f, 1, (long) (left * 5)));
        }
        Gui.drawRect(GuiScreen.width / 2 - 110, GuiScreen.height / 4 - 20, GuiScreen.width / 2 + 110, GuiScreen.height / 4 + 134, 0xDF181B20);
        mc.FontRendererLarge.drawCenteredString(I18n.format("Menu", new Object[0]), this.width / 2 - 2, 116, 16777215);
