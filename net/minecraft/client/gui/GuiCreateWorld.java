...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        mc.FontRendererNormal.drawCenteredString(I18n.format("selectWorld.create", new Object[0]), this.width / 2, 20, -1);

        if (this.field_146344_y)
        {
        	mc.FontRendererNormal.drawString(I18n.format("selectWorld.enterSeed", new Object[0]), this.width / 2 - 100, 44, -6250336);
        	mc.FontRendererNormal.drawString(I18n.format("selectWorld.seedInfo", new Object[0]), this.width / 2 - 100, 81, -6250336);

            if (this.btnMapFeatures.visible)
            {
            	mc.FontRendererNormal.drawString(I18n.format("selectWorld.mapFeatures.info", new Object[0]), this.width / 2 - 154, 119, -6250336);
            }

            if (this.btnAllowCommands.visible)
            {
            	mc.FontRendererNormal.drawString(I18n.format("selectWorld.allowCommands.info", new Object[0]), this.width / 2 - 154, 170, -6250336);
            }
        ...
        {
        	mc.FontRendererNormal.drawString(I18n.format("selectWorld.enterName", new Object[0]), this.width / 2 - 100, 45, -6250336);
        	mc.FontRendererNormal.drawString(I18n.format("selectWorld.resultFolder", new Object[0]) + " " + this.field_146336_i, this.width / 2 - 100, 82, -6250336);
            this.field_146333_g.drawTextBox();
            mc.FontRendererNormal.drawString(this.field_146323_G, this.width / 2 - 100, 137, -6250336);
            mc.FontRendererNormal.drawString(this.field_146328_H, this.width / 2 - 100, 149, -6250336);
        }
