...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
    	Client.getInstance().getVailRPC().update("", "Multiplayer Menu");
    ...
    {
        this.buttonList.add(new GuiButton(100, this.width / 2 - 264, this.height - 28, 100, 20, I18n.format("Generate Account", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        mc.FontRendererLarge.drawCenteredString(I18n.format("Multiplayer", new Object[0]), this.width / 2, 6, 16777215);
