...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        mc.FontRendererNormal.drawCenteredString(this.field_146628_f, this.width / 2, 10, 16777215);
    ...
    class List extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            mc.FontRendererNormal.drawString(s, p_180791_2_ + 2, p_180791_3_ - 2, 16777215);
            mc.FontRendererNormal.drawString(s1, p_180791_2_ + 2, p_180791_3_ + 9, 8421504);
            mc.FontRendererNormal.drawString(s2, p_180791_2_ + 2, p_180791_3_ + 9 + 10, 8421504);
        }
    }
}
