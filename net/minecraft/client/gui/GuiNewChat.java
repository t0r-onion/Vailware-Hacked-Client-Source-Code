    ...
    public void drawChat(int p_146230_1_)
    {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN)
        {
            ...
            if (k > 0)
            {
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 10;
                                drawRect(i2, j2 - 10, i2 + l, j2, l1 / 2 << 24);
                                String s = chatline.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                mc.FontRendererSmall.drawStringWithShadow(s, (float)i2, (float)(j2 - 11), 16777215 + (l1 << 24));
                ...
                if (flag)
                {
                    int k2 = mc.FontRendererSmall.FONT_HEIGHT;
