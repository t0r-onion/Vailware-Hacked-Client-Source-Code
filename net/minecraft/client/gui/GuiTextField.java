...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                drawRect(this.xPosition - 0.5f, this.yPosition - 0.5f, this.xPosition + this.width + 0.5f, this.yPosition + this.height + 0.5f, -6250336);
            ...
            int l = this.enableBackgroundDrawing ? this.xPosition: this.xPosition;
            ...
            if (s.length() > 0)
            {
                ...
                j1 = Minecraft.getMinecraft().FontRendererNormal.drawStringWithShadow(s1, (float)l + 2, (float)i1 - 3.4f, i);
            }
            ...
            {
                j1 = Minecraft.getMinecraft().FontRendererNormal.drawStringWithShadow(s.substring(j), (float)j1 * 2 + 4, (float)i1 - 3.5f, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    Gui.drawRect(k1 * 2 + 5, i1 - 1, k1 * 2 + 4, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                }
                else
                {
                	Minecraft.getMinecraft().FontRendererNormal.drawStringWithShadow("_", s.length() > 0 ? k1 * 2 : k1 + 2, (float)i1 - 3, i);
                }
            }

            if (k != j)
            {
                int l1 = l + Minecraft.getMinecraft().FontRendererNormal.getStringWidth(s.substring(0, k));
