...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("vail/background.png"));
        ...
        mc.FontRendererNormal.drawCenteredString(sb2.append(AltManager.registry.size()).append(" alts").toString(), width / 2, 4, -1);
        mc.FontRendererNormal.drawCenteredString(this.loginThread == null ? this.status : this.loginThread.getStatus(), width / 2, 14, -1);
        
        GlStateManager.color(0, 0, 0, 1);
        Draw.drawRoundedRect((int) 50.0f, 33.0f, width - 100, height - 100, 6);
        GL11.glPushMatrix();
        ...
        for (Alt alt2 : AltManager.registry) {
            ...
            if (alt2 == this.selectedAlt) {
                if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
                    Gui.drawRect((int) 82.0f, y2 - this.offset - 4, width - 82, y2 - this.offset + 20, -2142943931);
                } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                    Gui.drawRect((int) 82.0f, y2 - this.offset - 4, width - 82, y2 - this.offset + 20, -2142088622);
                } else {
                    Gui.drawRect((int) 82.0f, y2 - this.offset - 4, width - 82, y2 - this.offset + 20, -2144259791);
                }
                ...
                Gui.drawRect((int) 52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, 0x99000000);
            }
            mc.FontRendererNormal.drawCenteredString(name, width / 2, y2 - this.offset - 4, -1);
            mc.FontRendererNormal.drawCenteredString(pass, width / 2, y2 - this.offset + 10 - 1, 5592405);
            y2 += 26;
        }
        GL11.glDisable(3089);
        GL11.glPopMatrix();
