...
public class GlyphPage {
    ...
    public float pageX = 0;
    public float pageY = 0;
    ...
    public float drawChar(char ch, float x, float y) {
        ...
        try {
	        pageX = glyph.x / (float) imgSize;
	        pageY = glyph.y / (float) imgSize;
	
	        pageWidth = glyph.width / (float) imgSize;
	        pageHeight = glyph.height / (float) imgSize;
